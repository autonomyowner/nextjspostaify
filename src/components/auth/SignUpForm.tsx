        ...
        <form onSubmit={handleEmailSignUp} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-input border border-border rounded-lg text-white placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
            />
          </div>
